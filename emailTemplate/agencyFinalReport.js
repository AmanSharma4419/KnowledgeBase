const { LOGO,SUPPORT_EMAIL,SENDER_EMAIL } = require('../src/appConfig');
module.exports={
    template:(sendMailData,DISCLAIMER)=>{
        verificationName = sendMailData.verificationName
        requestId = sendMailData.requestId
        agentName = sendMailData.agentName
        return `<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
${verificationName} is completed for the ${requestId}.
${agentName} has uploaded the final report of the ${verificationName}.

<br>
<br>
Note: Please do not reply to this email. It is an auto generated email. For any query or clarification, please email at,
<span style="text-decoration:underline">${SENDER_EMAIL}</span><br>
<br>
With Regards,<br>
